...
export function FileViewer({ filePath }: FileViewerProps) {
  ...
  useEffect(() => {
    ...
    loadFile()
  }, [currentThreadId, filePath, content, setFileContents])
  ...
  useEffect(() => {
    ...
    async function highlight() {
      if (content === undefined || language === null) {
        // No content or unsupported language - skip highlighting
        setHighlightedHtml(null)
        return
      }
      ...
      try {
        ...
        console.log('[FileViewer] Highlighting complete, html length:', html.length)
